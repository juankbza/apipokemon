...
* 📦 **Descargar la APK (Instalador para Android):** [¡Descarga el APK aquí!](https://github.com/juankbza/apipokemon/releases/download/v1.0.1/app-release.apk)
...
1. **Clonar el repositorio:**
   ```bash
   git clone [https://github.com/juankbza/apipokemon.git](https://github.com/juankbza/apipokemon.git)